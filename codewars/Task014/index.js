...
// the function nb_year should return n
// number of entire years needed to get a population greater or equal to p.

// aug is an integer, percent a positive or
// null floating number, p0 and p are positive integers(> 0)
...
// as a percentage in the body of your function: if
...
function nbYear(p0, percent, aug, p) {
  ...
  for (years; p0 < p; years += 1) {
    p0 = Math.floor(p0 + p0 * truePercent + aug);
  }
  return years;
}

console.log(nbYear(1000, 2, 50, 121));
